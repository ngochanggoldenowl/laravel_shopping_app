								...
								<div class="cart-item">
									...
									<div class="media">
										...
										<div class="media-body">
											...
											<span class="cart-item-amount">@if($product['item']['promotion_price =0']){ {{number_format($product['item']['unit_price'])}} } @else {{number_format($product['item']['promotion_price'])}}  @endif*<span>{{$product['qty']}}</span></span>
										</div>
									</div>
								</div>
							@endforeach
