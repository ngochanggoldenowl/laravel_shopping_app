		...
		<div class="container">
			...
			<div class="pull-right">
				<div class="beta-breadcrumb font-large">
					<a href="index.html">Home</a> / <span>{{$loai_sp->name}}</span>
				</div>
			</div>
								...
								<div class="col-sm-4">
									<div class="single-item">
										<div class="single-item-header">
											<a href="product.html"><img height="250px" src="source/image/product/{{$sp->image}}" alt=""></a>
										</div>
						...
						<div class="beta-products-list">
							...
							<div class="row">
								...
								<div class="col-sm-4">
									<div class="single-item">
										<div class="single-item-header">
											<a href="product.html"><img height="250px"  src="source/image/product/{{$spkhac->image}}" alt=""></a>
										</div>
										<div class="single-item-body">
